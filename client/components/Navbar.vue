            ...
            <div class="nav-global-location">
              <nuxt-link to="/address" class="nav-a nav-a-2">
                ...
                <div id="glow-ingress-block">
                  <span class="nav-line-1" id="glow-ingress-line1">Livrate către</span>
                  <span
                    class="nav-line-2"
          ...
          <div class="col-xl-6 col-lg-5 col-md-4 col-sm-6 p-0">
            <div class="nav-fill">
              ...
              <div class="nav-xshop-container">
                <div class="nav-xshop">
                  <a href="#" class="nav-a">Oferte</a>
                  <a href="#" class="nav-a">Câștigă</a>
                  <a href="#" class="nav-a">Bonusuri</a>
                  <a href="#" class="nav-a">Despre noi</a>
            ...
            <div class="nav-tools">
              <a href="#" id="icp-nav-flyout" class="nav-a nav-a-2 icp-link-style-2">
                <span class="icp-nav-link-inner">
                  <span class="nav-line-1">
                    ...
                    <span class="icp-nav-language">RO</span>
                  </span>
              ...
              <template v-if="$auth.$state.loggedIn" true>
                <nuxt-link
                  ...
                  tabindex="0"
                >
                  <span class="nav-line-1">Către</span>
                  <span class="nav-line-2">Profil</span>
                </nuxt-link>
              </template>
              <template v-else>
                <nuxt-link
                  ...
                  tabindex="0"
                >
                  <span class="nav-line-1">Salut, Înregistrează-te</span>
                  <span class="nav-line-2">
                    Conturi &amp; Liste
                    <span class="nav-icon nav-arrow" style="visibility: visible"></span>
                  </span>
              ...
              <nuxt-link to="/orders" class="nav-a nav-a-2 nav-single-row-link">
                ...
                <span class="nav-line-2">Comenzi</span>
              </nuxt-link>

              <nuxt-link to="/cart" class="nav-a nav-a-2" id="nav-cart">
                <span aria-hidden="true" class="nav-line-1"></span>
                <span aria-hidden="true" class="nav-line-2">Coș</span>
